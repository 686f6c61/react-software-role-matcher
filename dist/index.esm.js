...
import { useState, useCallback, forwardRef, useContext, useLayoutEffect, useEffect, useRef, createContext, useMemo, Component, Fragment } from 'react';
...
var RoleMatcher = function (_a) {
    ...
    var _d = useState(null), selectedRole = _d[0], setSelectedRole = _d[1];
    var _e = useState(''), yearsExperience = _e[0], setYearsExperience = _e[1];
    var _f = useState(null), level = _f[0], setLevel = _f[1];
    ...
    if (isLoading) {
        return jsx$1("div", { className: "text-center py-4", children: "Loading..." });
    }
    if (error) {
        return jsx$1("div", { className: "text-red-500 py-2", children: error });
    }
    return (jsxs("div", { className: "role-matcher ".concat(className), children: [jsxs("div", { className: "mb-4", children: [jsx$1("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Buscador de roles profesionales" }), jsx$1(StateManagedSelect$1, { className: "role-select", classNamePrefix: "role-select", options: groupedOptions, onChange: handleRoleChange, placeholder: "Escribe para buscar...", isClearable: true, isSearchable: true, styles: {
                        ...
                        } })] }), selectedRole && (jsxs("div", { className: "mb-4", children: [jsxs("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: ["\u00BFCu\u00E1ntos a\u00F1os llevas siendo ", selectedRole.role, "?"] }), jsx$1("input", { type: "number", min: "0", value: yearsExperience, onChange: handleYearsChange, className: "block px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500", placeholder: "Introduce a\u00F1os de experiencia", style: { maxWidth: '350px', width: '100%' } })] })), level && (jsxs("div", { className: "mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200", children: [jsxs("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: ["Nivel profesional: ", jsx$1("span", { className: "font-bold text-indigo-600", children: level.level })] }), jsxs("div", { className: "text-sm text-gray-600 mb-2", children: ["A\u00F1os de experiencia: ", level.minExperience, "-", level.maxExperience] }), jsxs("div", { className: "mt-3", children: [jsx$1("h4", { className: "text-md font-medium text-gray-800 mb-1", children: "Habilidades esperadas:" }), jsx$1("p", { className: "text-gray-700 whitespace-pre-line", children: level.skills })] })] }))] }));
};

export { RoleMatcher, RoleMatcher as default, determineProfessionalLevel, fetchCSVData, parseCSVData };
